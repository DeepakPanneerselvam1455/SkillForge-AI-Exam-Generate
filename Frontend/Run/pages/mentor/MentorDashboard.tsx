    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
                <StatCard icon={<LibraryIcon className="w-8 h-8 text-blue-500" />} title="Total Courses" value={stats.courses} />
                <StatCard icon={<FileTextIcon className="w-8 h-8 text-orange-500" />} title="Total Quizzes" value={stats.quizzes} />
                <StatCard icon={<UsersIcon className="w-8 h-8 text-green-500" />} title="Engaged Students" value={stats.students} />
            </div>
            
            <Card>
                <CardHeader><CardTitle>Quick Actions</CardTitle></CardHeader>
                <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <Link to="/mentor/courses" className={cn(buttonVariants({ variant: 'outline' }), "flex items-center justify-center gap-2")}><PlusCircleIcon className="w-4 h-4"/>Create Course</Link>
                    <Link to="/mentor/courses" className={cn(buttonVariants({ variant: 'outline' }), "flex items-center justify-center gap-2")}><FilePlusIcon className="w-4 h-4"/>Create Quiz</Link>
                    <Link to="/mentor/analytics" className={cn(buttonVariants({ variant: 'outline' }), "flex items-center justify-center gap-2")}><AreaChartIcon className="w-4 h-4"/>View Analytics</Link>
                    <Button variant="outline" disabled className="flex items-center justify-center gap-2"><ClipboardEditIcon className="w-4 h-4" />Manage Assignments</Button>
                </CardContent>
            </Card>
...
const LibraryIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/></svg>
);
...
const HelpCircleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
);
...
const AreaChartIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><path d="M7 12v5h12V8l-5 5-4-4Z"/></svg>;
const ClipboardEditIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="8" height="4" x="8" y="2" rx="1" ry="1"/><path d="M10.4 12.6a2 2 0 0 1 3 3L8 21l-4 1 1-4Z"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-5.5"/><path d="M4 13.5V6a2 2 0 0 1 2-2h2"/></svg>;
