...
const navConfig = {
    ...
    admin: {
        ...
        links: [
            ...
            { to: '/admin/analytics', label: 'Course Management', icon: <FileAnalyticsIcon className={iconClass} /> },
...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <div className="flex h-screen bg-slate-100 dark:bg-slate-900">
            {/* Sidebar */}
            <aside className="w-64 flex-shrink-0 bg-slate-800 dark:bg-slate-950 text-white flex flex-col">
                ...
                <header className="bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 flex-shrink-0">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between h-16">
                            <h1 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-slate-50">{headerTitle}</h1>
