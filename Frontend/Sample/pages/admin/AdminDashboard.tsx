...
const AdminDashboard: React.FC = () => {
    ...
    const getActivityIcon = (type: ActivityLogEntry['type']) => {
        switch (type) {
            case 'user_create': return <UserPlusIcon className="w-5 h-5 text-blue-500" />;
            case 'course_create': return <BookUpIcon className="w-5 h-5 text-green-500" />;
            case 'quiz_submit': return <FileCheckIcon className="w-5 h-5 text-indigo-500" />;
            case 'user_login': return <LogInIcon className="w-5 h-5 text-slate-500" />;
            case 'user_delete': return <UserMinusIcon className="w-5 h-5 text-red-500" />;
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-3 lg:grid-cols-6">
                <StatCard icon={<UsersIcon className="w-6 h-6 text-indigo-500" />} title="Total Users" value={stats.users} />
                <StatCard icon={<GraduationCapIcon className="w-6 h-6 text-indigo-500" />} title="Students" value={stats.students} />
                <StatCard icon={<PresentationIcon className="w-6 h-6 text-indigo-500" />} title="Instructors" value={stats.mentors} />
                <StatCard icon={<ShieldIcon className="w-6 h-6 text-indigo-500" />} title="Admins" value={stats.admins} />
                <StatCard icon={<LibraryIcon className="w-6 h-6 text-indigo-500" />} title="Total Courses" value={stats.courses} />
                <StatCard icon={<FileQuestionIcon className="w-6 h-6 text-indigo-500" />} title="Total Quizzes" value={stats.quizzes} />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card>
                    ...
                    <CardContent className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <Button asChild className="flex items-center gap-2"><Link to="/admin/users/create"><UserPlusIcon className="w-4 h-4"/>Add User</Link></Button>
                        <Button asChild className="flex items-center gap-2"><Link to="/admin/analytics"><PlusCircleIcon className="w-4 h-4" />Create Course</Link></Button>
                        <Button asChild className="flex items-center gap-2"><Link to="/admin/reports"><FileBarChartIcon className="w-4 h-4" />View Reports</Link></Button>
                        <Button asChild className="flex items-center gap-2"><Link to="/admin/settings"><SettingsIcon className="w-4 h-4" />Settings</Link></Button>
                        <Button asChild className="flex items-center gap-2"><Link to="/admin/moderation"><ShieldCheckIcon className="w-4 h-4" />Moderation</Link></Button>
                        <Button asChild className="flex items-center gap-2"><Link to="/admin/security"><ShieldXIcon className="w-4 h-4" />Security</Link></Button>
                    </CardContent>
                </Card>
                <Card>
...
const ShieldIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>;
const LibraryIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/></svg>;
const FileQuestionIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><path d="M10 10.3c.2-.4.5-.8.9-1a2.1 2.1 0 0 1 2.6.4c.3.4.5.8.5 1.3 0 1.3-2 2-2 2"/><path d="M12 17h.01"/></svg>;
...
const LogInIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>;
const UserMinusIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="22" y1="11" x2="16" y2="11"/></svg>;
const InfoIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>;
