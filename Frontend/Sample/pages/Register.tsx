...
const RegisterPage: React.FC = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#6B73FF] to-[#A855F7] p-4">
            <div className="w-full max-w-md bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl mt-4 font-semibold text-slate-800">Create Account</h2>
                    <p className="text-slate-600 mt-1">Learn. Create. Excel.</p>
                </div>
                <form onSubmit={handleInitialSubmit} className="space-y-4">
                    <div>
                        ...
                        <Input
                            ...
                            className="bg-slate-100 border-slate-300 focus:bg-white"
                        />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <Input
                                ...
                                className="bg-slate-100 border-slate-300 focus:bg-white pr-10"
                            />
                            <button
                                type="button"
                    ...
                    <Button type="submit" className="w-full !mt-6 bg-gradient-to-r from-purple-600 to-indigo-600 text-lg py-3 h-auto">
                        Create Account
                    </Button>
                </form>
