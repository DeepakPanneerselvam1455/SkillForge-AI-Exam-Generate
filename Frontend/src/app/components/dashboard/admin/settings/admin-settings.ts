...
@Component({
  ...
  template: `<div class="dashboard-container"><header class="dashboard-header"><div class="header-content"><h1>System Settings</h1><div class="user-info"><span>Welcome, {{ user?.name }}!</span><button (click)="logout()" class="logout-btn">Logout</button></div></div></header><nav class="dashboard-nav"><div class="nav-content"><a routerLink="/dashboard/admin" class="nav-item">📊 Overview</a><a routerLink="/dashboard/admin/users" class="nav-item">👥 User Management</a><a routerLink="/dashboard/admin/courses" class="nav-item">📚 Course Management</a><a routerLink="/dashboard/admin/analytics" class="nav-item">📈 Analytics</a><a routerLink="/dashboard/admin/settings" routerLinkActive="active" class="nav-item">⚙️ Settings</a></div></nav><main class="dashboard-main"><h2>System Settings - Coming Soon</h2></main></div>`,
