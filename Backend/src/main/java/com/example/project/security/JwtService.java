...
public class JwtService {
    ...
    public String generateRefreshToken(String username, Map<String, Object> extraClaims) {
        return buildToken(extraClaims, username, refreshExpirationMs);
    }
    ...
    private String buildToken(Map<String, Object> extraClaims, String username, long expirationMillis) {
        Date now = new Date();
